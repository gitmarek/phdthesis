...
jeśli isnitje odwzorowanie rzutowe o normie jednostkowej (niekoniecznie normalne)
...
%\begin{Lemma}
%Niech $E\subset \mathcal{CB}(\mathfrak{M}_*,\mathfrak{N})_+$
%oraz $B_{1}$ będzie kulą jednostkową w $\mathcal{CB}(\mathfrak{M}_*,\mathfrak{N})$
%(względem tzw. $\mathcal{CB}$-normy, tj. naturalnej normy odwzorowań kompletnie ograniczonych).
%Niech także zbiór $E \cap B_{1}$ będzie gęsty w  be dense in  $\cbms_+ \cap B_{1}$ in the
