...
%W następnym rozdziale będziemy zakładać, że przynajmniej jedna spośród algebr
%von Neumanna jest algebrą iniektywną (por. str. \pageref{def:injectivevNalg}).
%W tym miejscu przywołajmy jedynie twierdzenie, którego dowód można odnaleść
%w książce M.\,Takesaki, \emph{Theory of operator algebras}, t.\,3,
%twierdzenie , str.  \cite{Takesaki3}
