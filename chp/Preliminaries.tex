...
jest przestrzenią liniową $V \! \otimes \! W$, rozpiętą przez wektory
...
w której zdefiniowane jest mnożenie elementów, spełniające warunek:
\begin{linenomath*}
 \begin{equation}
...
\begin{Definition}
    ...
    projektor w $\mathfrak{M}$ majoryzuje pewien niezerowy projektor przemienny
    w $\mathfrak{M}$.
...
w pracy \cite{choi1975completely}.
...
gdzie $\mathbb{C}^{n} \ni \eta, \xi \neq 0$ jest dowolną parą wektorów,
